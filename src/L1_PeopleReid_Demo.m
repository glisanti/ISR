...
%% Dataset Parameters
datasetname = 'VIPeR'; % Dataset name: CAVIARa or VIPeR
...
maxNumTemplate = 1;     % Number of exemplars in the GALLERY
maxNumTemplateTest = 1; % Number of exemplars in the PROBE
